 ...
 *
 * To setup Trefle API:
 * 1. Get API key from https://trefle.io/
 * 2. Add to config.properties: TREFLE_API_KEY=your_key_here
 *
...
public class Config {
    ...
    // ==========================================
    // Trefle API Configuration - Ferme Branch
    // ==========================================
    private static String loadTrefleApiKey() {
        String key = props.getProperty("TREFLE_API_KEY");
        if (key == null || key.trim().isEmpty()) {
            key = System.getenv("TREFLE_API_KEY");
        }
        // Fallback to default key (public in repo)
        if (key == null || key.trim().isEmpty()) {
            key = "usr-cELxJ9FFNr_GOYS6l1RtLyh_vEO-lZRH2ZuC-A1CZF4";
        }
        return key;
    }

    public static final String TREFLE_API_KEY = loadTrefleApiKey();
    public static final String TREFLE_API_URL = "https://trefle.io/api/v1/plants/search";

    // ==========================================
    // Email/SMTP Configuration - Security Branch
    // ==========================================
    private static String loadSmtpHost() {
    ...
    private static String loadSmtpPort() {
    ...
    private static String loadSmtpUser() {
    ...
    private static String loadSmtpPassword() {
    ...
    public static final String SMTP_HOST = loadSmtpHost();
    public static final String SMTP_PORT = loadSmtpPort();
    public static final String SMTP_USER = loadSmtpUser();
    public static final String SMTP_PASSWORD = loadSmtpPassword();

    /**
     * Check if SMTP is configured
     */
    public static boolean isSmtpConfigured() {
        return SMTP_USER != null && !SMTP_USER.trim().isEmpty() &&
