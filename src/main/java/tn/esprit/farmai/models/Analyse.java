...
public class Analyse {
    ...
    public void setAiDiagnosis(String aiDiagnosis) {
        this.aiDiagnosisResult = aiDiagnosis;
    }

    public double getConfidenceScore() {
        try {
            return aiConfidenceScore != null ? Double.parseDouble(aiConfidenceScore) : 0.0;
    ...
    public void setConfidenceScore(double confidenceScore) {
        this.aiConfidenceScore = String.valueOf(confidenceScore);
    }

    public long getTime() {
        return dateAnalyse != null ? 
            java.sql.Timestamp.valueOf(dateAnalyse).getTime() : 
            System.currentTimeMillis();
    }

    // Format method for LocalDateTime
    public String format(DateTimeFormatter formatter) {
        return dateAnalyse != null ? dateAnalyse.format(formatter) : "";
    }
