...
public class TestBD {
    public static void main(String[] args) {
        try {
            ...
            as.updateOne(testA);
            Analyse updatedAnalyse = as.findById(testA.getIdAnalyse());
            System.out.println("Analyse mise à jour : " + (updatedAnalyse != null ? updatedAnalyse.getResultatTechnique() : "null"));
