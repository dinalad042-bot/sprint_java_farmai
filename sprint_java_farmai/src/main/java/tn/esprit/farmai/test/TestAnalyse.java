    ...
    private static void testAnalyseService() {
        ...
        try {
            ...
            if (analyse.getIdAnalyse() > 0) {
                System.out.println("\n3. Testing findById()...");
                Analyse foundAnalyse = analyseService.findById(analyse.getIdAnalyse()).orElse(null);
    ...
    private static void testConseilService() {
        ...
        try {
            ...
            if (conseil.getIdConseil() > 0) {
                System.out.println("\n3. Testing findById()...");
                Conseil foundConseil = conseilService.findById(conseil.getIdConseil()).orElse(null);
                if (foundConseil != null) {
